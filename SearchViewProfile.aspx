<%@ Page Title="" Language="C#" MasterPageFile="~/LinkedU.Master" AutoEventWireup="true" CodeBehind="SearchViewProfile.aspx.cs" Inherits="LinkedU.SearchViewProfile" %>
            ...
            <div class="site site sign-up-panel-2">
                <div class="sign-up-form">
                    ...
                    <asp:Panel runat="server">
                        <asp:Button ID="schedule" runat="server" Text="Schedule Appointment" CssClass="btn btn-primary"  style="float:right" />
